          	...
          	<div class="row">
		    					<div class="sidebar-box ftco-animate">
						              ...
						              <form action="Reserve" method="post">
						                <h3>Chambre Réservée</h3>
						                <li><a href="#">Description <span>${room.descp_ch}</span></a></li>
						                <li><a href="#">Superficie <span>${room.superfice}</span></a></li>
						                <li><a href="#">Prix <span>${room.prix_ch}</span></a></li>
						                <li><a href="#">Date d'arrivé <span><%= date_dep %></span></a></li>
						                <li><a href="#">Date de départ <span><%= date_arr %></span></a></li>
