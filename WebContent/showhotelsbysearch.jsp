        ...
        <div class="row">
        	<div class="col-lg-3 sidebar order-md-last ftco-animate">
        		...
        		<form action="FilterBy" method="post">
        			...
        			<br>
        				<input type="radio" name="stars" value="500"> Moins que 500 DH<br>
        				  <input type="radio" name="stars" value="1"> 1 Etoiles<br>
          ...
          <div class="col-lg-9">
          	<div class="row">
          			 <c:forEach var = "h" items = "${hotels}" varStatus="status"> 
