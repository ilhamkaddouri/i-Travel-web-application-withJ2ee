    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bg_1.jpg');">
      ...
      <div class="container">
        <div class="row">
        		...
        		<div class="sidebar-wrap ftco-animate">
        			...
        			<form action="AddRating" method="post" class="star-rating">
							 <div class="col-md align-items-end">
							  ...
							  <div class="form-group">
				                <input type="submit" name="radtingadd" value="Valider" class="btn btn-primary py-3 px-5">
				              </div>
							</form>
        		</div>
          </div><!-- END-->
          <div class="col-lg-9">
          	<div class="row">
          	<c:forEach var = "h" items = "${indexhotelList}" varStatus="status"> 
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="ShowRooms">${h.getNom_hotel()}</a></h3>
				    						<p class="rate">
				    							<span>${h.getNbr_etoiles()} Etoiles</span>
				    						</p>
			    						</div>
			    						<div class="two">
