		    					...
		    					<div class="sidebar-box ftco-animate">
						              ...
						              <form action="Reserve" method="post">
						                ...
						                <table border=1 style="width: 100%">
											...
											<c:forEach var = "r" items = "${reserves}"> 
											<tr>
												<td>${personne.nom_prs}</td>
												<td>${personne.prenom_prs}</td>
												<td>${personne.email}</td>
												<td>${personne.tel_prs}</td>
												<td>${r.getDate_res()}</td>
												<td>${r.getDate_dep()}</td>
												<td>${r.getDate_arr()}</td>
												<td><a href="EditReservation?id_res=${r.getId_res()}" >Valider</a></td>
												<td><a href="DeleteReservation?id_res=${r.getId_res()}">Annuler</a></td>
												<td>
												<c:if test="${r.getConfirmation() != 0}">
													validé
												</c:if>
												<c:if test="${r.getConfirmation() == 0}">
												Non validé
